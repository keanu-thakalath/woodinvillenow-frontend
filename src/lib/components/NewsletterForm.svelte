...
<form on:submit|preventDefault={handleSubmit} class="mt-5">
    <div class="relative">
        <input on:input={handleInputChange} bind:this={input} class="{compact ? 'pl-10 text-sm border-emerald-400 focus:border-emerald-500' : 'focus:border-emerald-400 pl-12 text-lg'} w-full p-2 rounded focus:outline-none border border-gray-200" type="email" placeholder="Email">
